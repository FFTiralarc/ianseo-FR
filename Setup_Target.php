...
switch($TourType) {
	case 3:
		switch($SubRule) {
            ...
            case 14: // selectif + para
                ...
                CreateDistanceNew($TourId, $TourType, 'CLU11F', array(array('20m-1',20), array('20m-2',20)));
                CreateDistanceNew($TourId, $TourType, 'CLU11H', array(array('20m-1',20), array('20m-2',20)));
                ...
                CreateDistanceNew($TourId, $TourType, 'COU13F', array(array('40m-1',40), array('40m-2',40)));
                CreateDistanceNew($TourId, $TourType, 'COU13H', array(array('40m-1',40), array('40m-2',40)));
                CreateDistanceNew($TourId, $TourType, 'COU15F', array(array('40m-1',40), array('40m-2',40)));
                CreateDistanceNew($TourId, $TourType, 'COU15H', array(array('40m-1',40), array('40m-2',40)));
                CreateDistanceNew($TourId, $TourType, 'COU18%', array(array('50m-1',50), array('50m-2',50)));
                CreateDistanceNew($TourId, $TourType, 'COU2%', array(array('50m-1',50), array('50m-2',50)));
                CreateDistanceNew($TourId, $TourType, 'COS%', array(array('50m-1',50), array('50m-2',50)));


                CreateDistanceNew($TourId, $TourType, 'CLU11W', array(array('15m-1',15), array('15m-2',15)));
                CreateDistanceNew($TourId, $TourType, 'CLU11M', array(array('15m-1',15), array('15m-2',15)));
                ...
                CreateDistanceNew($TourId, $TourType, 'COU13W', array(array('30m-1',30), array('30m-2',30)));
                CreateDistanceNew($TourId, $TourType, 'COU13M', array(array('30m-1',30), array('30m-2',30)));
                CreateDistanceNew($TourId, $TourType, 'COU15W', array(array('30m-1',30), array('30m-2',30)));
                CreateDistanceNew($TourId, $TourType, 'COU15M', array(array('30m-1',30), array('30m-2',30)));

                CreateDistanceNew($TourId, $TourType, 'BBU13%', array(array('30m-1',30), array('30m-2',30)));
                CreateDistanceNew($TourId, $TourType, 'BBU15%', array(array('30m-1',30), array('30m-2',30)));
                CreateDistanceNew($TourId, $TourType, 'BBU18%', array(array('50m-1',50), array('50m-2',50)));
    ...
    case 50:
		...
		CreateDistanceNew($TourId, $TourType, 'CLU18%', array(array('50m',50)));
		CreateDistanceNew($TourId, $TourType, 'CLU21%', array(array('50m',50)));
		CreateDistanceNew($TourId, $TourType, 'COU18%', array(array('50m',50)));
		CreateDistanceNew($TourId, $TourType, 'COU21%', array(array('50m',50)));
		CreateDistanceNew($TourId, $TourType, 'BBU18%', array(array('30m',30)));
		CreateDistanceNew($TourId, $TourType, 'BBU21%', array(array('30m',30)));
		CreateDistanceNew($TourId, $TourType, 'ADU18%', array(array('30m',30)));
		CreateDistanceNew($TourId, $TourType, 'ADU21%', array(array('30m',30)));
	...
	case 6: // 18m
		switch($SubRule) {
			...
			case '4': // selectif + para
				// All classes
				CreateTargetFace($TourId, $TgtId++, 'Blason Unique 40cm', 'REG-(^(CL|BB)(U18|U2|S))'.($SubRule==4 ? '|(^OPCLS)|(^OPCLU2)|(^FECLS)|(^FECLU2)|(^W1)' : ''), '1', 1, 40, 1, 40);
				CreateTargetFace($TourId, $TgtId++, 'Blason Unique 60cm', 'REG-(^(CL|BB)U1[1-5])'.($SubRule==4 ? '|(^CH)|(^CR)|(^H)|(^OPC.U1)|(^FEC.U1)' : ''), '1', 1, 60, 1, 60);
				...
				if($SubRule==4) {
					CreateTargetFace($TourId, $TgtId++, 'Blason Unique 80cm', 'REG-(^SU)', '1', 1, 80, 1, 80);
				}

				// optional target faces
				CreateTargetFace($TourId, $TgtId++, 'Trispot Classique 6-10 40cm', 'REG-(^(CL|BB)(U18|U2|S))'.($SubRule==4 ? '|(^OPCLS)|(^OPCLU2)|(^FECLS)|(^FECLU2)|(^W1)' : ''), '',  2, 40, 2, 40);
				CreateTargetFace($TourId, $TgtId++, 'Trispot Classique 6-10 60cm', 'REG-(^CLU15|^BBU1[3-5])', '',  2, 60, 2, 60);
				break;
			case '2':
		...
		break;
	case 7:
		CreateTargetFace($TourId, $TgtId++, 'Blason Unique 60cm', 'REG-(^(CL|BB)(U18|U2|S))', '1', 1, 60, 1, 60);
		CreateTargetFace($TourId, $TgtId++, 'Blason Unique 80cm', 'REG-(^(CL|BB)U1[1-5])', '1', 1, 80, 1, 80);
		CreateTargetFace($TourId, $TgtId++, 'Trispot Poulie 6-10 60cm', 'CO%', '1', 4, 60, 4, 60);
		// optional target faces
		CreateTargetFace($TourId, $TgtId++, 'Trispot Classique 60cm', 'REG-(^(CL|BB)(U18|U2|S))', '', 2, 60, 2, 60);
		break;
	case 8:
		CreateTargetFace($TourId, $TgtId++, 'Blason Unique 60cm/40cm', 'REG-(^(CL|BB)(U18|U2|S))', '1', 1, 60, 1, 60,  1, 40, 1, 40);
		CreateTargetFace($TourId, $TgtId++, 'Blason Unique 80cm/60cm', 'REG-(^(CL|BB)U1[1-5])', '1', 1, 80, 1, 80, 1, 60, 1, 60);
		CreateTargetFace($TourId, $TgtId++, 'Trispot Poulie 6-10 60cm', 'CO%', '1', 4, 60, 4, 60, 4, 40, 4, 40);
		// optional target faces
